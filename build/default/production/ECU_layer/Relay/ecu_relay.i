...
# 38 "ECU_layer/Relay/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
Std_ReturnType relay_initialize(const relay_t *_relay) {
    ...
    if (((void*)0) == _relay) {
        ...
        pin_config_t pin_opj = {.port = _relay->port_name, .pin = _relay->pin, .direction = GPIO_DIRECTION_OUTPUT, .logic = _relay->relay_status};
        gpio_pin_intialize(&pin_opj);
    }
    return ret;
}
...
Std_ReturnType relay_turn_on(const relay_t *_relay) {
    ...
    if (((void*)0) == _relay) {
        ...
        pin_config_t pin_opj = {.port = _relay->port_name, .pin = _relay->pin, .direction = GPIO_DIRECTION_OUTPUT, .logic = _relay->relay_status};
        gpio_pin_write_logic(&pin_opj, GPIO_HIGH);
    }
    return ret;
}
# 53 "ECU_layer/Relay/ecu_relay.c"
Std_ReturnType relay_turn_off(const relay_t *_relay) {
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (((void*)0) == _relay) {
        ret = (Std_ReturnType)0x00;
        ...
        pin_config_t pin_opj = {.port = _relay->port_name, .pin = _relay->pin, .direction = GPIO_DIRECTION_OUTPUT, .logic = _relay->relay_status};
        gpio_pin_write_logic(&pin_opj, GPIO_LOW);
    }
    return ret;
}
